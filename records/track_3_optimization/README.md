...
| 4 | 3300 | MuonH (Muon + hyperball constraint on hidden matrices) with per-module init scaling (attn.proj×1.25, mlp.proj×3.0, mlp.fc×1.5 Kaiming), lr=.018 h_cooldown_frac=1.0 aux_cooldown_frac=.4 | 2026/04/29 | [log](results/275ee3b9-6110-49b8-92d9-a0e9137c3d31.txt) | @kaiyue-wen |
